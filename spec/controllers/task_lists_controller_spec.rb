  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved task_list as @task_list" do
        ...
        post :create, {:task_list => { "name" => "invalid value" }}, valid_session
        assigns(:task_list).should be_a_new(TaskList)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested task_list" do
        ...
        TaskList.any_instance.should_receive(:update).with({ "name" => "MyString" })
        put :update, {:id => task_list.to_param, :task_list => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the task_list as @task_list" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        TaskList.any_instance.stub(:save).and_return(false)
        put :update, {:id => task_list.to_param, :task_list => { "name" => "invalid value" }}, valid_session
        assigns(:task_list).should eq(task_list)
      end
